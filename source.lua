...
tag = tostring(game.Players.LocalPlayer.UserId)
...
local StaminaLoss
StaminaToggles:Toggle("Stamina Loss",false,function(Value)
if TestRequire() ~= true then
...
val = tonumber(text)
elseif text == "inf" or text == "mathhuge" or text == "math.huge" or text == "infinity" or text == "INF" or text == "Inf" or text == "Infinity" or text == "INFINITY" or text = "Unlimited" or text == "unlimited" or text == "UNLIMITED" or text == "inf." or text == "Inf." or text == "INF." then
val = (math and math.huge) or 9e9
else
DiscordLib:Notification("Error!", "You should put a number or ''inf''!", "Okay!")
return nil
end
...
DiscordLib:Notification("Error!", "You should put a number!", "Okay!")
return nil
end
...
local function GetRandomAbility()
...
local Ability = Window:Server("Abilities Management","rbxassetid://97428323453639")
...
local preferedability_1_incard_1
preferedability_1_incard_1 = "N/A"
...
local preferedability_2_incard_1
preferedability_2_incard_1 = "N/A"
...
local preferedability_1_incard_2
preferedability_1_incard_2 = "N/A"
CardsGive:Dropdown("Pick First Ability",{"Cloak","Punch","Taunt","BonusPad","Block","Caretaker","Dash","Hotdog","Revolver","Adrenaline"},function(Value)
preferedability_1_incard_2 = tostring(Value)
end)
local preferedability_2_incard_2
preferedability_2_incard_2 = "N/A"
CardsGive:Dropdown("Pick Second Ability",{"Cloak","Punch","Taunt","BonusPad","Block","Caretaker","Dash","Hotdog","Revolver","Adrenaline"},function(Value)
preferedability_2_incard_2 = tostring(Value)
end)

CardsGive:Label("Third Card Settings")
local preferedability_1_incard_3
preferedability_1_incard_3 = "N/A"
CardsGive:Dropdown("Pick First Ability",{"Cloak","Punch","Taunt","BonusPad","Block","Caretaker","Dash","Hotdog","Revolver","Adrenaline"},function(Value)
preferedability_1_incard_3 = tostring(Value)
end)
local preferedability_2_incard_3
preferedability_2_incard_3 = "N/A"
CardsGive:Dropdown("Pick Second Ability",{"Cloak","Punch","Taunt","BonusPad","Block","Caretaker","Dash","Hotdog","Revolver","Adrenaline"},function(Value)
...
VisualESP:Slider("ESP Transparency ( in % )", 0, 100, 50, function(Value)
...
GuiChanger:Button("Disable ''Hallucination'' Effect", function()
game:GetService("Players"):WaitForChild("Sounds"):WaitForChild("SFX"):WaitForChild("Hallucination"):Destroy()
game:GetService("Players"):WaitForChild("Sounds"):WaitForChild("SFX"):WaitForChild("Hallucination2"):Destroy()
game:GetService("Players"):WaitForChild("Sounds"):WaitForChild("SFX"):WaitForChild("Hallucination3"):Destroy()
game:GetService("Players"):WaitForChild("Sounds"):WaitForChild("SFX"):WaitForChild("Hallucination4"):Destroy()
game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui"):WaitForChild("MainGui"):WaitForChild("Hallucination"):Destroy()
DiscordLib:Notification("Success!", "Disabled ''Hallucination'' Effect!", "Okay!")
end)
...
local AntiWalls
AntiWalls = false
AntiThings:Toggle("Auto-Destroy Badware Computers [ You have to be close to prompt ]",false,function(Value)
if not fireproximityprompt then
DiscordLib:Notification("Error!", "Your executor doesn't support ''fireproximityprompt'' function, which is being used in this feature!", "Okay!")
return nil
end
AntiWalls = Value
if AntiWalls == true then
...
task.wait(.05)
pcall(function()
if descendant ~= nil and descendant and descendant.Parent and (descendant.Parent.Position - HRP.Position).magnitude < 6 then
if descendant.HoldDuration ~= 0 then
descendant.HoldDuration = 0
end
if descendant.RequiresLineOfSight ~= false then
descendant.RequiresLineOfSight = false
end
if descendant.MaxActivationDistance ~= 9e9 then
descendant.MaxActivationDistance = 9e9
end
...
if descendant and descendant:IsA("ProximityPrompt") and descendant.Parent and descendant.Parent.Name == "Primary" and AntiWalls == true then
pcall(function()
while descendant ~= nil do
task.wait(.05)
pcall(function()
...
AnimationFolder:FindFirstChild("HurtSprint").AnimationId = "rbxassetid://124260679864309"
end
if AnimationFolder:FindFirstChild("NormalSprint") then
AnimationFolder:FindFirstChild("NormalSprint").AnimationId = "rbxassetid://124260679864309"
end
if AnimationFolder:FindFirstChild("OldSprint") then
AnimationFolder:FindFirstChild("OldSprint").AnimationId = "rbxassetid://124260679864309"
end
if AnimationFolder:FindFirstChild("Sprint") then
AnimationFolder:FindFirstChild("Sprint").AnimationId = "rbxassetid://124260679864309"
end
if AnimationFolder:FindFirstChild("Idle") then
AnimationFolder:FindFirstChild("Idle").AnimationId = "rbxassetid://110395159339100"
end
if AnimationFolder:FindFirstChild("OldIdle") then
AnimationFolder:FindFirstChild("OldIdle").AnimationId = "rbxassetid://110395159339100"
end
if AnimationFolder:FindFirstChild("Walk") then
AnimationFolder:FindFirstChild("Walk").AnimationId = "rbxassetid://124260679864309"
end
if AnimationFolder:FindFirstChild("OldWalk") then
AnimationFolder:FindFirstChild("OldWalk").AnimationId = "rbxassetid://124260679864309"
end
end)
